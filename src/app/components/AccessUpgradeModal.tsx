...
export function AccessUpgradeModal({ isOpen, onClose, onUpgrade, currentUser }: AccessUpgradeModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-sm w-[95vw] sm:w-[90vw] max-h-[92vh] p-0 border-2 border-cyan-500/30 bg-slate-900 rounded-xl sm:rounded-2xl shadow-xl !absolute !top-1/2 !left-1/2 !-translate-x-1/2 !-translate-y-1/2 overflow-y-auto overflow-x-hidden !z-[60]">
