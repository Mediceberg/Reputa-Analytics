...
export function AccessUpgradeModal({ isOpen, onClose, onUpgrade, currentUser }: AccessUpgradeModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md max-h-[92vh] overflow-y-auto p-0 border-2 border-cyan-500/30 bg-gradient-to-br from-slate-900/98 via-slate-800/98 to-slate-900/98 rounded-3xl shadow-2xl shadow-cyan-500/20 backdrop-blur-xl">
        {/* Background Effects */}
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4 px-5 py-2 mb-4">
            ...
            {/* Security Note */}
            <div className="flex items-center justify-center gap-2 text-[10px] text-gray-500 pb-2">
