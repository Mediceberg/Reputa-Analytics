mport { ArrowLeft, ArrowRight } from 'lucide-react';
...
export function TransactionList({ transactions, walletAddress }: TransactionListProps) {
 ...
 const formatDate = (date: Date) => {
  ...
  // للحماية من أي توقيت مستقبلي ناتج عن اختلاف الساعات
  ...
  const months = Math.floor(days / 30.44); // استخدام المتوسط الدقيق للشهر
  const years = Math.floor(days / 365.25);

  // المنطق التسلسلي للدقة
