...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'app.mode.mainnet': 'Mainnet Mode',
    'app.mode.impact.full': '100% Impact',
    'app.mode.impact.partial': '25% Impact',
    'app.mode.impact.none': 'No Impact',
    'app.mode.network': 'Network Mode',
    'app.mode.selectMode': 'Select Network Mode',
    'app.mode.mainnet.desc': 'Full reputation on Pi Mainnet',
    'app.mode.testnet.desc': 'Test with reduced impact',
    'app.mode.demo.desc': 'Explore without real impact',
    'app.mode.loginRequired': 'Login Required',
    'app.mode.footer': 'Real reputation is based on Mainnet data. Testnet adds supplementary points only.',
    ...
    'sidebar.earnPoints': 'Earn Points',
  ...
  ar: {
    ...
    'app.mode.testnet': 'شبكة الاختبار',
    'app.mode.mainnet': 'الشبكة الرئيسية',
    'app.mode.impact.full': 'تأثير كامل 100%',
    'app.mode.impact.partial': 'تأثير جزئي 25%',
    'app.mode.impact.none': 'بدون تأثير',
    'app.mode.network': 'وضع الشبكة',
    'app.mode.selectMode': 'اختر وضع الشبكة',
    'app.mode.mainnet.desc': 'سمعة كاملة على الشبكة الرئيسية',
    'app.mode.testnet.desc': 'اختبار مع تأثير مخفض',
    'app.mode.demo.desc': 'استكشف بدون تأثير حقيقي',
    'app.mode.loginRequired': 'تسجيل الدخول مطلوب',
    'app.mode.footer': 'السمعة الحقيقية تعتمد على بيانات الشبكة الرئيسية. شبكة الاختبار تضيف نقاط مكملة فقط.',
  ...
  fr: {
    ...
    'app.mode.mainnet': 'Mode Mainnet',
    'app.mode.impact.full': 'Impact 100%',
    'app.mode.impact.partial': 'Impact 25%',
    'app.mode.impact.none': 'Sans impact',
    'app.mode.network': 'Mode Réseau',
    'app.mode.selectMode': 'Sélectionner le mode réseau',
    'app.mode.mainnet.desc': 'Réputation complète sur le Mainnet Pi',
    'app.mode.testnet.desc': 'Test avec impact réduit',
    'app.mode.demo.desc': 'Explorer sans impact réel',
    'app.mode.loginRequired': 'Connexion requise',
    'app.mode.footer': 'La réputation réelle est basée sur les données du Mainnet. Le Testnet ajoute uniquement des points supplémentaires.',
    ...
    'sidebar.earnPoints': 'Gagner des points',
  ...
  zh: {
    ...
    'app.mode.mainnet': '主网模式',
    'app.mode.impact.full': '100% 影响',
    'app.mode.impact.partial': '25% 影响',
    'app.mode.impact.none': '无影响',
    'app.mode.network': '网络模式',
    'app.mode.selectMode': '选择网络模式',
    'app.mode.mainnet.desc': '主网上的完整声誉',
    'app.mode.testnet.desc': '测试模式，影响减少',
    'app.mode.demo.desc': '无实际影响的探索模式',
    'app.mode.loginRequired': '需要登录',
    'app.mode.footer': '真实声誉基于主网数据。测试网仅添加补充积分。',
