...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'app.mode.selectMode': 'Select operating mode for reputation',
  ...
  ar: {
    ...
    'app.mode.selectMode': 'اختر وضع التشغيل للسمعة',
  ...
  fr: {
    ...
    'app.mode.selectMode': 'Sélectionnez le mode pour la réputation',
